  ...
  return (
    <Card className="border-none rounded-[10px] overflow-hidden bg-white">
      <CardHeader className="bg-slate-50/50 p-8 border-b border-slate-100">
        <CardTitle className="text-xl font-normal text-slate-900">
          Process Payment
        </CardTitle>
      </CardHeader>
      <CardContent className="p-8">
        {isSuccess ? (
          <div className="flex flex-col items-center justify-center py-8 space-y-4 text-center animate-in zoom-in-95 duration-300">
            <div
              className={cn(
                "h-16 w-16 rounded-[10px] flex items-center justify-center",
            ...
            <div className="space-y-6">
              ...
              <div className="bg-slate-50 p-6 rounded-[10px] border border-slate-100">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Badge
                    variant="outline"
                    className="text-[10px] font-normal border-slate-200 text-slate-500 bg-white"
                  >
                    {method === PaymentMethod.MobileMoney
                      ? "USSD Push"
                      : "Direct"}
